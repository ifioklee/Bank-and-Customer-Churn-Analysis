...
## Project Overview
This repository contains details and documents relating to a bank and customer churn analysis of a fictitious bank

The project was carried out using **Power Query** for data transformation and **Power BI** for visualizing insights.  
Working on this analysis involved the use of:
...
### Raw Dataset
The original datasets used for this analysis can be found in the folder below:
